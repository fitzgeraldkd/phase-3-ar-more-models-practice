...
PlantCategory.create(plant_id: basil.id, category_id: Category.first.id)
PlantCategory.create(plant_id: corn_tree.id, category_id: Category.second.id)
PlantCategory.create(plant_id: prayer_plant.id, category_id: Category.second.id)
PlantCategory.create(plant_id: cactus_1.id, category_id: Category.second.id)
PlantCategory.create(plant_id: elephant_bush.id, category_id: Category.first.id)
PlantCategory.create(plant_id: photos.id, category_id: Category.second.id)
PlantCategory.create(plant_id: dragon_tree.id, category_id: Category.second.id)
PlantCategory.create(plant_id: snake_plant.id, category_id: Category.second.id)
PlantCategory.create(plant_id: polka_dot_plant.id, category_id: Category.first.id)
PlantCategory.create(plant_id: cactus_2.id, category_id: Category.first.id)
# binding.pry
...
Watering.create(wateree: basil, waterer: joel)